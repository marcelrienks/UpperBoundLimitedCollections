...
{
    [TestClass]
    public class StrictUpperBoundLimitedDictionaryTests
    {
        /// <summary>
        ...
        public void InitializeStrictStrictUpperBoundLimitedListWithZeroLimit()
        {
            ...
            // Assert
            var exception = Assert.ThrowsException<ArgumentOutOfRangeException>(() => new StrictUpperBoundLimitedDictionary<string, string>(upperBoundLimit), "Exception thrown does not match expected type 'ArgumentNullException'.");
        ...
        public void AddNullKey()
        {
            ...
            // Variables
            var dictionary = new StrictUpperBoundLimitedDictionary<string, string>(upperBoundLimit);

            // Assert
            var exception = Assert.ThrowsException<ArgumentNullException>(() => dictionary.Add(key, value), "Exception thrown does not match expected type 'ArgumentNullException'.");
